...
<div class="kt-aside  kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop" id="kt_aside">
    ...
    <div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
        <div class="kt-aside__brand-logo">
            <a href="{{url('/')}}">
                <img alt="Logo" src="{{asset('img/MNV-logo.png')}}" style="width: 125px;"/>
            </a>
        </div>
    ...
    <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
        <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
            <ul class="kt-menu__nav ">
                <li class="kt-menu__item  <?= ( strpos($current_params, 'IndexController') ) ? 'kt-menu__item--active' : ''; ?>" aria-haspopup="true">
                    <a href="{{url('/')}}" class="kt-menu__link ">
                        <span class="kt-menu__link-icon"><i class="fa fa-chart-line"></i></span>
                        <span class="kt-menu__link-text">{{trans('cms.dashboard')}}</span>
                    </a>
                </li>
                <li class="kt-menu__section ">
                    <h4 class="kt-menu__section-text">{{trans('cms.modules')}}</h4>
                    <i class="kt-menu__section-icon flaticon-more-v2"></i>
                </li>
                <li class="kt-menu__item  kt-menu__item--submenu <?= ( strpos($current_params, 'UsersController') ) ? 'kt-menu__item--open' : ''; ?>" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                    <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                        <span class="kt-menu__link-icon"><i class="fa fa-users"></i></span>
                        <span class="kt-menu__link-text">{{trans('cms.users')}}</span><i class="kt-menu__ver-arrow la la-angle-right"></i>
                    </a>
                    <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                        <ul class="kt-menu__subnav">
                            <li class="kt-menu__item <?= ( strpos($current_params, 'UsersController@index') ) ? 'kt-menu__item--active' : ''; ?>" aria-haspopup="true">
                                <a href="{{url('users/')}}" class="kt-menu__link ">
                                    <i class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span class="kt-menu__link-text">{{trans('cms.all_users')}}</span>
                                </a>
                            </li>
                            <li class="kt-menu__item <?= ( strpos($current_params, 'UsersController@create') ) ? 'kt-menu__item--active' : ''; ?>" aria-haspopup="true">
                                <a href="{{url('users/create')}}" class="kt-menu__link ">
                                    <i class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span class="kt-menu__link-text">{{trans('cms.new_user')}}</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li class="kt-menu__item  kt-menu__item--submenu <?= ( strpos($current_params, 'MembersController') ) ? 'kt-menu__item--open' : ''; ?>" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                    <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                        <span class="kt-menu__link-icon"><i class="fa fa-user-tie"></i></span>
                        <span class="kt-menu__link-text">{{trans('cms.members')}}</span><i class="kt-menu__ver-arrow la la-angle-right"></i>
                    </a>
                    <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                        <ul class="kt-menu__subnav">
                            <li class="kt-menu__item <?= ( strpos($current_params, 'MembersController@index') ) ? 'kt-menu__item--active' : ''; ?>" aria-haspopup="true">
                                <a href="{{url('members/')}}" class="kt-menu__link ">
                ...
                <li class="kt-menu__item  kt-menu__item--submenu <?= ( strpos($current_params, 'ContactUsController') || strpos($current_params, 'AboutUsController') || strpos($current_params, 'OurGoalsController') ) ? 'kt-menu__item--open' : ''; ?>" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                    <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                ...
                <li class="kt-menu__item " aria-haspopup="true">
                    <a href="custom/apps/inbox.html" class="kt-menu__link ">
                        ...
                        <span class="kt-menu__link-text">{{trans('cms.logos')}}</span>
                    </a>
                </li>
            </ul>
        </div>
