...
@section('content')
    <div class="wrapper" style="margin-top:72px;">
        <div id="rev_slider_48_1_wrapper" dir="ltr" class="rev_slider_wrapper fullwidthbanner-container" data-alias="demo_magazine" data-source="gallery" style="margin:0px auto;background:transparent;padding:0px;margin-top:0px;margin-bottom:0px;">
            <div id="rev_slider_48_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.8.1">
                <ul>
                    <li data-index="rs-191" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="img/demo_magazine/revslider_img/100x50_3890e-1290x1080_1.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide #1" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <img src="img/demo_magazine/revslider_img/3890e-1290x1080_1.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5" class="rev-slidebg" data-no-retina>
        ...
        <section class="row no-gutters">
            <div class="col-xl-4">
                <div class="blog-grid-card lazyload blog-grid-card_small blog-grid-card_white" data-bg="img/demo_magazine/640x420_1.jpg" data-brk-library="component__blog_grid">
                    ...
                    <div class="blog-grid-card__item text-center">
                        <a href="#" class="blog-grid-card__avatar">
                            <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="img/demo_magazine/116x116_6.jpg" alt="alt" class="lazyload">
                        </a>
                        <a href="#" class="blog-grid-card__name font__family-montserrat font__weight-bold font__size-14 line__height-16">Nekro Merinstar</a>
                        <a href="#" class="blog-grid-card__title font__family-montserrat font__weight-bold">
                            Stay on budget
                        </a>
                        ...
                        <div class="d-flex justify-content-center flex-wrap">
                            <a href="#" class="blog-grid-card__cat font__family-montserrat font__weight-bold font__size-14 line__height-22">Men’s News</a>
            ...
            <div class="col-xl-4">
                <div class="blog-grid-card lazyload blog-grid-card_small blog-grid-card_dark" data-bg="img/demo_magazine/640x420_2.jpg" data-brk-library="component__blog_grid">
                    ...
                    <div class="blog-grid-card__item text-center">
                        <a href="#" class="blog-grid-card__avatar">
                            <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="img/demo_magazine/116x116_7.jpg" alt="alt" class="lazyload">
                        </a>
                        <a href="#" class="blog-grid-card__name font__family-montserrat font__weight-bold font__size-14 line__height-16">Nekro Merinstar</a>
                        <a href="#" class="blog-grid-card__title font__family-montserrat font__weight-bold">
            ...
            <div class="col-xl-4">
                <div class="blog-grid-card lazyload blog-grid-card_small blog-grid-card_white" data-bg="img/demo_magazine/640x420_3.jpg" data-brk-library="component__blog_grid">
                    ...
                    <div class="blog-grid-card__item text-center">
                        <a href="#" class="blog-grid-card__avatar">
                            <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="img/demo_magazine/116x116_3.jpg" alt="alt" class="lazyload">
                        </a>
                        <a href="#" class="blog-grid-card__name font__family-montserrat font__weight-bold font__size-14 line__height-16">Nekro Merinstar</a>
                        <a href="#" class="blog-grid-card__title font__family-montserrat font__weight-bold">
                            Wrap up the project
                ...
                <div class="row no-gutters">
                    <div class="col-xl-6">
                        <div class="blog-grid-card lazyload blog-grid-card_small blog-grid-card_dark" data-bg="img/demo_magazine/640x420_2.jpg" data-brk-library="component__blog_grid">
                            ...
                            <div class="blog-grid-card__item text-center">
                                <a href="#" class="blog-grid-card__avatar">
                                    <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="img/demo_magazine/116x116_4.jpg" alt="alt" class="lazyload">
                                </a>
                                <a href="#" class="blog-grid-card__name font__family-montserrat font__weight-bold font__size-14 line__height-16">Nekro Merinstar</a>
                                <a href="#" class="blog-grid-card__title font__family-montserrat font__weight-bold">
                    ...
                    <div class="col-xl-6">
                        <div class="blog-grid-card lazyload blog-grid-card_small blog-grid-card_white" data-bg="img/demo_magazine/640x420_4.jpg" data-brk-library="component__blog_grid">
                            ...
                            <div class="blog-grid-card__item text-center">
                                <a href="#" class="blog-grid-card__avatar">
                                    <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="img/demo_magazine/116x116_5.jpg" alt="alt" class="lazyload">
                                </a>
                                <a href="#" class="blog-grid-card__name font__family-montserrat font__weight-bold font__size-14 line__height-16">Nekro Merinstar</a>
                                <a href="#" class="blog-grid-card__title font__family-montserrat font__weight-bold">
                                    Schedule a meeting
        ...
        <section class="brk-base-bg-6 pt-lg-100 pt-50 pb-lg-80">
            <div class="font__size-46 line__height-60 text-center mb-lg-90 pb-50 text-white">
                ...
                <span class="font__family-montserrat font__weight-bold text-uppercase">History</span>
            </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="post-filmstrip swiper-slide" data-caption="Feb, 2008">
                            <div class="timeline__item">
                                <div class="timeline__content text-left brk-dark-font-color">
                                    ...
                                    <p class="mt-20 brk-dark-font-color font__family-roboto font__weight-light font__size-15 letter-spacing--1 line__height-26">Aenean vulputate eleifend tellusnean leo ligula, porttitor eu, sequat vitae, eleifend ac, enim. Aliquam lorem
                                        ante, dapibus in, viverra quis.</p>
                                </div>
                                <img class="mt-30 lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="img/timeline/timeline_content_06.jpg" alt="alt">
                            </div>
                        </div>
                        <div class="post-filmstrip swiper-slide" data-caption="Apr, 2009">
                            <div class="timeline__item">
                                ...
                                <img class="mt-30 lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="img/timeline/timeline_content_07.jpg" alt="alt">
                            </div>
                        </div>
                        <div class="post-filmstrip swiper-slide" data-caption="Jul, 2011">
                            <div class="timeline__item">
                                ...
                                <img class="mt-30 lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="img/timeline/timeline_content_08.jpg" alt="alt">
                            </div>
                        </div>
                        <div class="post-filmstrip swiper-slide" data-caption="Dec, 2013">
                            <div class="timeline__item">
                                ...
                                <img class="mt-30 lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="img/timeline/timeline_content_09.jpg" alt="alt">
                            </div>
                        </div>
