...
@section('content')
        ...
        <div class="container">
            <div class="breadcrumbs__wrapper">
                <div class="pull-left text-left" data-brk-library="component__title">
                    <h2 class="brk-white-font-color font__size-36 line__height-50 font__family-montserrat-alt font__weight-bold">About Us</h2>
                ...
                <ol class="breadcrumb pull-right font__size-14 font__weight-bold font__family-montserrat">
                    <li><a href="#">Bread <i class="fas fa-arrow-right"></i></a></li>
                    <li class="active">Crumbs</li>
                </ol>
            </div>
        </div>
    </div>
    <h1 class="sr-only">Magazine - About Us</h1>
    <div class="brk-bg-light-dark-2 bg-cover bg-norepeat bg-position_bottom-center pt-80 pb-80 lazyload" data-bg="img/demo_magazine/1920x908_1.png">
        <div class="container"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="img/demo_magazine/1170x478_1.jpg" alt="alt" class="img-fluid mb-50 lazyload">
            <div class="brk-tabs brk-tabs-icon-left" data-hash="true" data-brk-library="component__tabs">
                ...
                <div class="brk-tabs-content">
                    <div id="tab-1" class="brk-tab-item">
                        ...
                        <div class="float-right mt-10 ml-lg-4" style="width: 100%;max-width: 470px"><img class="float-left mr-lg-4" src="img/demo_magazine/letter-colored.png" alt="alt">
                    ...
                    <div id="tab-3" class="brk-tab-item">
                        ...
                        <div class="cfa__wrapper cfa__container bg__style overlay__gradient all-light text-center text-lg-left lazyload" data-bg="img/1170x108_2.jpg" data-brk-library="component__call_to_action">
                            ...
                            <p class="font__family-open-sans font__size-14 brk-white-font-color opacity-70 text-center text-lg-left brk-dark-font-color">Call for action Block heading title goes</p><span class="overlay_after brk-base-bg-gradient-90deg-96"></span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="brk-base-bg-6 pt-lg-100 pb-lg-90 pt-70 pb-70">
        <div class="text-center mb-20 mb-xl-0"><span class="d-inline-block brk-text-clip bg-cover font__weight-bold text-uppercase magazine-big-font mb-30">Our Awards</span></div>
        <div class="container">
            <div class="row">
                <div class="col-xl-3">
                    <div class="counter__wrapper-filled gray text-center" data-brk-library="component__counter">
                        <div class="counter-wrap"><svg>
                                <circle cx="93" cy="93" r="93" /></svg>
                        ...
                        <h4 class="text-white font__family-montserrat font__weight-bold font__size-19 line__height-22 mt-30">Some item title<br>goes here</h4>
                    </div>
                </div>
                <div class="col-xl-3">
                    <div class="counter__wrapper-filled gray text-center" data-brk-library="component__counter">
    ...
    <div class="container pt-lg-80 pb-lg-80 pt-70 pb-70">
        <div class="icon__wrapper-main icon__wrapper-strict active__effect-main" data-brk-library="component__sequence">
            <div class="row row-no-gutter">
                <div class="col-lg-4">
                    <div class="icon__wrapper active__effect pt-50 pb-50 pl-50 pr-50"><span class="bg-before bg__style lazyload" data-bg="img/demo_magazine/390x370_1.jpg"></span> <span class="grad-overlay"></span>
                        <h2 class="font__family-montserrat font__size-124 font__weight-light number">01</h2>
                        <h4 class="font__family-montserrat font__size-24 font__weight-light line__height-30 text-uppercase">We Build Amazing<br><span class="font__weight-bold">Projects</span></h4><a href="#" class="font__family-open-sans font__size-16 font__weight-bold text-uppercase link">Read More <i class="icon fa fa-long-arrow-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="icon__wrapper z-index-2 active__effect active current pt-50 pb-50 pl-50 pr-50"><span class="bg-before bg__style lazyload" data-bg="img/demo_magazine/390x370_2.jpg"></span> <span class="grad-overlay"></span>
                        <h2 class="font__family-montserrat font__size-124 font__weight-light number">02</h2>
                        <h4 class="font__family-montserrat font__size-24 font__weight-light line__height-30 text-uppercase">We Build Amazing<br><span class="font__weight-bold">Projects</span></h4><a href="#" class="font__family-open-sans font__size-16 font__weight-bold text-uppercase link">Read More <i class="icon fa fa-long-arrow-right"></i></a> <span class="triangle triangle-after fa fa-angle-right brk-base-bg-6"></span> <span class="triangle triangle-before fa fa-angle-right brk-base-bg-6"></span>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="icon__wrapper active__effect pt-50 pb-50 pl-50 pr-50"><span class="bg-before bg__style lazyload" data-bg="img/demo_magazine/390x370_3.jpg"></span> <span class="grad-overlay"></span>
